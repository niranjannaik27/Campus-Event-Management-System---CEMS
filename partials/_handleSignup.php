    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($numRows){
            ...
            if($user_password==$user_cpassword){
                ...
                if($result){
                    $showAlert=true;
                    header("Location:/CampusEventManagamentSystem/index.php?signupsuccess=true");
                    exit();
                }
            }
            else{
        ...
        header("Location:/CampusEventManagamentSystem/index.php?signupsuccess=false&error=$showError");
