    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="signupModalLabel">Signup for an EVE PESU account</h5>
            ...
            <form style="font-weight:bold;" action="partials/_handleSignup.php" method="post" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="signupUSN" name="signupUSN" aria-describedby="emailHelp" placeholder="ex : PESXUGXXCSXXX" required>
                    </div>
                    <div class="form-group">
