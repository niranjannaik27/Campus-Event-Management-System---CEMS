<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
      ...
      if($result){
        ...
        echo "<script type='text/javascript'>alert('The record has not been inserted because there is no account in Eve PESU with this usn.');</script>";  
      }
    }
  }
?>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/Campus Event Management System/winner.php?update=true" method="post" autocomplete="off">
  ...
  ?>
    ...
    <?php
        if($_SESSION['uname']=="admin"){
            ...
            <form action="/CampusEventManagementSystem/winner.php" method="post">
    ...
    Array.from(deletes).forEach((element) => {
        element.addEventListener("click", (e) => {
            ...
            if (confirm("Are you sure you want to delete this winner information")) {
                console.log("Yes");
                window.location = `/CampusEventManagementSystem/winner.php?delete=${sno}`;
            } else {
                console.log("No");
            }
        })
