...
<body style="background-color:#7c2387;">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/CampusEventManagementSystem/events.php?update=true" method="post" autocomplete="off">
  ...
  ?>
        ...
        <h2 class="text-center" style="padding-top:20px;font-weight:bold;">Add an event to Eve PESU</h2>
        <form action="/CampusEventManagementSystem/events.php" method="post">
    ...
    Array.from(deletes).forEach((element) => {
        element.addEventListener("click", (e) => {
            ...
            if (confirm("Are you sure you want to delete this event")) {
                console.log("Yes");
                window.location = `/CampusEventManagementSystem/events.php?delete=${sno}`;
